...
class ColorPalette:
    def __init__(self, width:int,height:int, square_side:int): 
        self.w = width
        self.h = height
        ...
        # This class cointains a predefined set of colored squares that will be used as accessible colors for drawing
